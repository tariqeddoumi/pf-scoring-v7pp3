...
CREATE TABLE IF NOT EXISTS "Evaluation" (
  ...
  "modelVersion" TEXT NOT NULL DEFAULT 'V7++.3',
  "createdById" TEXT NOT NULL REFERENCES "User"(id),
...
CREATE TABLE IF NOT EXISTS "NoGoRule" (
  id TEXT PRIMARY KEY DEFAULT gen_random_uuid()::text,
  "ruleSetId" TEXT REFERENCES "RuleSet"(id) ON DELETE SET NULL,
  code TEXT NOT NULL UNIQUE,
  title TEXT NOT NULL,
  scope TEXT,
  ...
  "committeeFlag" BOOLEAN NOT NULL DEFAULT FALSE,
  "displayOrder" INT NOT NULL DEFAULT 100,
  "isActive" BOOLEAN NOT NULL DEFAULT TRUE,
  "createdAt" TIMESTAMP NOT NULL DEFAULT NOW(),
  "updatedAt" TIMESTAMP NOT NULL DEFAULT NOW()
...
CREATE TABLE IF NOT EXISTS "CommitteeTemplate" (
  id TEXT PRIMARY KEY DEFAULT gen_random_uuid()::text,
  code TEXT NOT NULL UNIQUE,
  label TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_evaluation_project ON "Evaluation"("projectId");
CREATE INDEX IF NOT EXISTS idx_decision_evaluation ON "EvaluationDecision"("evaluationId");
CREATE INDEX IF NOT EXISTS idx_domain_code ON "ScoreDomain"(code);
CREATE INDEX IF NOT EXISTS idx_criterion_domain ON "ScoreCriterion"("domainId");
CREATE INDEX IF NOT EXISTS idx_rule_severity ON "NoGoRule"(severity);
