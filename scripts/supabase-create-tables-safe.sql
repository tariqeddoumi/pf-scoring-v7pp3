-- ============================================================================
-- PF SCORING V7++ - Safe Schema Creation (IF NOT EXISTS)
-- This version skips ENUMs and creates only missing tables
-- ============================================================================

-- ============================================================================
-- NOTE: ENUMs already exist, so we skip them
-- If needed, drop and recreate manually:
...
SELECT 'SUCCESS: All missing BP_PF tables created/verified!' as status,
       CURRENT_TIMESTAMP as created_at,
       'Tables created with IF NOT EXISTS clause' as note;
